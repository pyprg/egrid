...
from egrid._types import (
    ...
    Slacknode, Defk, Deft, Klink, Tlink, PValue, QValue, Output)
from egrid.factors import (
    make_factordefs, _get_scaling_factor_data, make_factor_meta,
    _get_taps_factor_data, get_factors, get_parts_of_injections,
...
#               'inj02_3', 'inj02_3', 'inj02_4', 'inj02_4', 'inj02_4', 'inj02_5', 
#               'inj02_5'])
#         self.assertEqual(
